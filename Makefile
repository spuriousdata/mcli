#############################################################################
# Makefile for building: mci
# Generated by qmake (2.01a) (Qt 4.5.0) on: Wed Jun 10 20:41:33 2009
# Project:  mci.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.5/mkspecs/macx-g++ -macx CONFIG+=debug_and_release -o Makefile mci.pro
#############################################################################
...
Makefile: mci.pro  /usr/local/Qt4.5/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.5/mkspecs/macx-g++ -macx CONFIG+=debug_and_release -o Makefile mci.pro
